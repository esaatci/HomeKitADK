...
#define kIID_LightBulbColor                    ((uint64_t) 0x0035)
...
/**
 * The 'Color' characteristic of the Light Bulb service.
 */
const HAPUInt32Characteristic lightBulbColorCharacteristic = {
    .format = kHAPCharacteristicFormat_UInt32,
    .iid = kIID_LightBulbColor,
    ...
    .callbacks = { .handleRead = HandleLightBulbColorRead, .handleWrite = HandleLightBulbColorWrite }
};

/**
 * The Light Bulb service that contains the 'On' and 'Brightness' characteristic.
 */
